...
try {
    // Query untuk mengambil semua lowongan aktif
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-links">
            <a href="jobs.php" class="nav-link active">All Jobs</a>
            ...
            <?php if(mysqli_num_rows($result) > 0): ?>
                <?php while($job = mysqli_fetch_assoc($result)): ?>
                    <div class="job-card">
                        ...
                        <h3 class="job-title">
                            <a href="job-detail.php?id=<?php echo htmlspecialchars($job['id_lowongan']); ?>">
